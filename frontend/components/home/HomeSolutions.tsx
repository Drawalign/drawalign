            ...
            >
              ...
              <div
                className={cn(
                  ...
                  isEven
                    ? "pr-5 pl-5 md:pr-0 md:pl-5 xl:pr-20 xl:pl-10"
                    : "pr-5 pl-5 md:pr-5 md:pl-5 xl:pr-10 xl:pl-20",
                  "text-white",
                )}
              >
                <div className="flex flex-col gap-6">
                  ...
                  {item.description && (
                    <p className="text-sm tracking-[-4.5%] lg:text-base">
                      {item.description}
                    </p>
                  )}
