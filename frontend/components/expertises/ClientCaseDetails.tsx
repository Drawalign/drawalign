...
function NumberedSection({
	...
	return (
		<div className="flex flex-col gap-5">
			...
			{children && <div className="flex flex-col gap-6 md:ml-10">{children}</div>}
		</div>
	);
}
...
function HighlightBox({
	...
	return (
		...
		>
			...
			<p className="whitespace-pre-line text-base text-white leading-tight">{text}</p>
		</div>
	);
}
		...
		<Section id="case-details" className="flex flex-col gap-10 lg:px-37">
			...
			>
				...
				<div className="flex flex-col gap-4">
					...
					<h3 className="text-2xl leading-tight tracking-tighter lg:text-32">{item.title}</h3>
				</div>
