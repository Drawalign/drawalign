		...
		<SplitCard className="p-5">
			...
			<div className="flex flex-col justify-between gap-8 bg-primary p-8 lg:p-14">
				<div className="flex flex-col gap-6">
					<h2 className="text-2xl text-white md:text-4xl lg:text-40">{maturity_title}</h2>
					{maturity_text && (
						<p className="text-base text-white leading-tight lg:text-lg">{maturity_text}</p>
					)}
				</div>
				<div className="border-l px-5">
					...
					{highlight_text && (
						<p className="text-base text-white leading-tight lg:text-2xl">{highlight_text}</p>
					)}
				</div>
			</div>
		</SplitCard>
