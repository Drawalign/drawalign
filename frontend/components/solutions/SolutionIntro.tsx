...
export function SolutionIntro({
  ...
  return (
    <div
      className={cn(
        "flex flex-col justify-center gap-5 overflow-hidden rounded-2xl lg:flex-row",
      )}
    >
      ...
      >
        <div className="flex flex-col gap-8">
          {logo ? (
            ...
            <p className="font-medium text-40 text-foreground leading-[0.9]">
              {name}
            </p>
          )}
          {title && (
          ...
          {description && (
            <p className="max-w-125 text-sm tracking-[-4.5%] leading-tight lg:text-lg">
              {description}
            </p>
          )}
        </div>
